...
namespace PWMS.DataClass
{
    ...
    class MyMeans
    {
       ...
       // public static string M_str_sqlcon = "Data Source=PXC-PC;Database=db_PWMS;User id=sa;PWD=";
        public static string M_str_sqlcon = "Data Source=PXC-PC;initial catalog=db_PWMS;integrated security=SSPI";
